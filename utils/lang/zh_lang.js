...
var Languague = {
  ...
  page: {
    ...
    seaReward:{
      ...
      RankFocus: '等级详情',
      Howtogetthere1:'海里累积',
      CaptainGetThere1:'海里是抵现奖励计划的计算单位。通过海里抵现，您可以根据自己的等级和订舱金额获得海里及相应的抵扣奖励。首先，您需要获取报价、订舱并支付账单，然后您将获得有效海里数。',
      benefits1:'海里抵扣',
      CaptainBenefits1:'无论您选择哪条航线或运输何种货物，在决定使用海里抵现权益后，您都可以随时在实时报价和订舱过程中使用累积的海里进行抵扣，从而节省海运费用。',
      Howtogetthere2:'获取报价、订舱、支付账单及累积海里',
      MasterGetThere2:'成功订舱即可获得奖励，无论需要运输任何类型的集装箱或货物，达飞都为您提供全新的奖励计划。只需简单4个步骤：获取报价、订舱、支付账单及累积海里。',
      Howtogetthere3:'消费获海里，升级享权益',
      AdmiralGetThere3:'升级等级以获得更多权益。加入该计划后，您的初始等级为中尉。达飞将在每个季度根据您在过去6个月内成功订舱的记录更新等级。',
      benefits: '等级权益',
      benefits1:'',
