...
var Languague = {
  ...
  page: {
    ...
    seaReward:{
      ...
      Lieutenant: '中尉',
      LieutenantText1:'每消费100$累积2海里',
      LieutenantText2: '要达到上尉级别，您需要预订至少1个TEU（标准箱），为期20周（共26周）',
      LieutenantBenefits: '每消费100 USD累积2海里', 
      Captain: '上尉',
      CaptainText1:'20周内预定至少1个TEU（标准箱）',
      CaptainText2:'每消费100$累积4海里',
      Master: '船长',
      MasterText1: '20周内预定至少15个TEU（标准箱）',
      ...
      AdmiralGetThere3:'成功订舱的记录将决定您的等级。' +
          '达飞将在每个季度根据您在过去6个月（26周）内成功订舱的记录更新等级。',
      benefits: '等级权益',
