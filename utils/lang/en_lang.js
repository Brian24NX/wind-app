...
var Languague = {
  ...
  page: {
    ...
    seaReward:{
      ...
      LieutenantText2: 'To reach the Captain level, you need to book minimum 3 TEUs per week for at least 13 weeks',

      LieutenantBenefits: 'Earn 2 Nautical Miles for 100 dollars spent', 
      Captain: 'Captain',
      CaptainText1:'Earn 4 Nautical Miles for 100 dollars spent',
      CaptainText2:'To reach the Master level, you need to book minimum 25 TEUs per week for at least 16 weeks',

      CaptainGetThere: 'To reach the Captain level, you need to book minimum 3 TEUs per week for at least 13 weeks',
      CaptainBenefits: 'Earn 4 Nautical Miles for 100 dollars spent',
      Master: 'Master',
      MasterText1: 'Earn 6 Nautical Miles for 100 dollars spent',
      MasterText2:'To reach the Admiral level, you need to book minimum 120 TEUs per week for at least 20 weeks',

      MasterGetThere: 'To reach the Master level, you need to book minimum 25 TEUs per week for at least 16 weeks',
      MasterBenefits: 'Earn 6 Nautical Miles for 100 dollars spent',
      Admiral: 'Admiral',
      AdmiralText1: 'Earn 8 Nautical Miles for 100 dollars spent',
      
      AdmiralGetThere: 'To reach the Admiral level, you need to book minimum 120 TEUs per week for at least 20 weeks',
      AdmiralBenefits: 'Earn 8 Nautical Miles for 100 dollars spent',
      Howtogetthere: 'How to get there',
      NauticalMilesFocus: 'Nautical Miles Focus',
      NauticalMilesCycle: 'Nautical Miles Cycle',
      RankFocus: 'Rank Focus',
