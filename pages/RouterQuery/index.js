    ...
    if (data.length < 2) {
      ...
      if(wx.getStorageSync('partnerList')[0]?.code == '0002130568'){
        ...
        if(data.indexOf('H')!==-1||data.indexOf('h')!==-1){
          ...
          list=[{"pointCode":"BEANR","point":"ANTWERP;BE;BEANR"}]
        }if(data.indexOf('F')!==-1||data.indexOf('f')!==-1){
            list=[{"pointCode": "FRPAR", "point": "PARIS, 75;FR;FRPAR"}]
        }if(data.indexOf('CN')!==-1||data.indexOf('cn')!==-1){
    ...
    if (data.length < 2) {
      ...
      if(wx.getStorageSync('partnerList')[0]?.code == '0002130568'){
        ...
        if(data.indexOf('H')!==-1||data.indexOf('h')!==-1){
          ...
          list=[{"pointCode": "FRPAR", "point": "PARIS, 75;FR;FRPAR"}]
        }if(data.indexOf('FR')!==-1||data.indexOf('fr')!==-1){
